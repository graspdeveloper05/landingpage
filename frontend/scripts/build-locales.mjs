...
const src = {
  ...
  rsvp: {
    ...
    fields: {
      ...
      yes: L('Yes', 'Ya', '是', 'ஆம்'),
      no: L('No', 'Tidak', '否', 'இல்லை'),
      cheveningScholar: L('Are you a Chevening scholar?', 'Adakah anda penerima biasiswa Chevening?', '您是 Chevening 奖学金得主吗？', 'நீங்கள் Chevening உதவித்தொகை பெற்றவரா?'),
      cheveningCohort: L('Your Chevening cohort', 'Kohort Chevening anda', '您的 Chevening 届别', 'உங்கள் Chevening தொகுதி'),
      cheveningCohortHint: L('For example, 2019/20.', 'Contohnya, 2019/20.', '例如：2019/20。', 'எடுத்துக்காட்டாக, 2019/20.'),
      cheveningUniversity: L(
        'Your university (under the Chevening scholarship)',
        'Universiti anda (di bawah biasiswa Chevening)',
        '您的大学（Chevening 奖学金期间）',
        'உங்கள் பல்கலைக்கழகம் (Chevening உதவித்தொகையின் கீழ்)',
      ),
      camMember: L('Are you a CAM member?', 'Adakah anda ahli CAM?', '您是 CAM 会员吗？', 'நீங்கள் CAM உறுப்பினரா?'),
    },
    ...
    errors: {
      ...
      choose: L('Choose yes or no.', 'Pilih ya atau tidak.', '请选择是或否。', 'ஆம் அல்லது இல்லை என்பதைத் தேர்ந்தெடுக்கவும்.'),
      cheveningCohort: L('Enter your Chevening cohort.', 'Masukkan kohort Chevening anda.', '请填写您的 Chevening 届别。', 'உங்கள் Chevening தொகுதியை உள்ளிடுங்கள்.'),
      cheveningUniversity: L('Enter your university.', 'Masukkan universiti anda.', '请填写您的大学。', 'உங்கள் பல்கலைக்கழகத்தை உள்ளிடுங்கள்.'),
  ...
  privacy: {
    ...
    body: [
      ...
      L(
        "A copy of your registration is also recorded in the organising team's own registration form (Google Forms), where Chevening Alumni Malaysia keeps the attendee list.",
        'Salinan pendaftaran anda turut direkodkan dalam borang pendaftaran pihak penganjur sendiri (Google Forms), tempat Chevening Alumni Malaysia menyimpan senarai peserta.',
        '您的报名资料副本亦会记录于筹委会自己的报名表格（Google 表单），Chevening Alumni Malaysia 在该处保存出席者名单。',
        'உங்கள் பதிவின் நகல் ஏற்பாட்டுக் குழுவின் சொந்தப் பதிவுப் படிவத்திலும் (Google Forms) பதிவு செய்யப்படும்; அங்கு Chevening Alumni Malaysia பங்கேற்பாளர் பட்டியலை வைத்திருக்கிறது.',
      ),
      L(
